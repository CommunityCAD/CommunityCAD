...
use App\Http\Controllers\Staff\PendingUsersController;
...
// } else {
Route::get('pending_users', [PendingUsersController::class, 'index'])->name('pending_users.index')->middleware('can:application_access');
Route::put('/pending_users/{user}', [PendingUsersController::class, 'update'])->name('pending_users.update')->middleware('can:application_action');
// }
