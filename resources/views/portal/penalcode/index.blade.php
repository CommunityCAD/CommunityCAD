...
@section('content')
    <header class="w-full my-3">
        <h1 class="text-2xl font-bold text-white">Penal Code</h1>
        <p class="text-sm text-white"></p>
    </header>

    <div class="admin-card select-none" x-data="">
                    ...
                    @foreach ($title->penal_code_codes() as $code)
                        <div class="border-l-4 border-white" x-data="{ 'is_code_open': false }">
                            ...
                            <p @click="is_code_open = !is_code_open"
                                class="ml-3 cursor-pointer font-semibold text-white text-lg">PC -
