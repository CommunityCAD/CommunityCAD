...
@section('content')
    <nav class="flex justify-between mb-4 border-b border-gray-700" aria-label="Breadcrumb">
        <div class="">
            <p class="text-lg dark:text-white">All User Accounts</p>
        </div>
        ...
        <div class="w-full px-6 py-8 mt-6 mb-6 overflow-hidden shadow-md bg-[#124559] sm:max-w-4xl sm:rounded-lg text-white">
            ...
            <div class="mb-3">
                @can('user_advanced_access')
                    <a class="px-2 py-1 bg-blue-500 rounded hover:bg-blue-600" href="{{ route('admin.users.index') }}">
                        View Only Members
                    </a>
                @endcan
            </div>
            ...
            <table class="w-full border border-collapse table-auto border-spacing-2 border-slate-500">
                <thead>
                    <tr>
                        ...
                        <th class="border border-spacing-2 border-slate-500">Account Status</th>
                        <th></th>
                    </tr>
                </thead>
