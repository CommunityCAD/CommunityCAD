...
@section('content')
    ...
    <div class="flex flex-col items-center pt-5 pb-5 sm:justify-center">
        ...
        <div
            class="w-full px-6 py-8 mt-6 mb-6 bg-white shadow-md dark:bg-[#124559] sm:max-w-5xl sm:rounded-lg text-gray-900 dark:text-white">
            <div class="md:flex md:-mx-2 ">
                <!-- Left Side -->
                <div class="w-full md:w-3/12 md:mx-2">
                    <!-- Profile Card -->
                    <div class="p-3 dark:bg-[#124559]">
                ...
                <div class="w-full mx-2 md:w-9/12">
                    ...
                    <div class="p-3 dark:bg-[#124559] text-[#eff6e0] rounded-sm shadow-sm">
                        <div>
                            <div
                                class="flex items-center justify-between mb-3 font-semibold leading-8 border-b border-black">
                    ...
                    @can('user_edit')
                        ...
                        <div class="p-3 dark:bg-[#124559] text-[#eff6e0]">
                            <div>
                                <div
                                    class="flex items-center justify-between mb-3 font-semibold leading-8 border-b border-black">
                                    <div class="flex items-center space-x-2">
                    ...
                    @can(['user_edit', 'user_edit'])
                        ...
                        <div class="p-3 dark:bg-[#124559] text-[#eff6e0]">
                            <div>
                                ...
                                <div class="flex flex-wrap p-3">
                                    <a href="#" class="px-2 py-1 m-1 text-black rounded bg-slate-300">Manage
                                        Departments</a>
