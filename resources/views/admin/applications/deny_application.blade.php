...
@section('content')
    <div class="flex flex-col items-center pt-5 pb-5 sm:justify-center">
        ...
        <h2 class="text-2xl font-bold dark:text-gray-200">Deny Application</h2>
        ...
        <div class="w-full px-6 py-8 mt-6 mb-6 overflow-hidden shadow-md bg-[#124559] sm:max-w-4xl sm:rounded-lg text-white">
            ...
            <form action="{{ route('admin.application.deny_application.store', $application->id) }}" method="POST">
                @csrf
                @method('PUT')
