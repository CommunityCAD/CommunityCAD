...
@section('content')
    <div class="card">
        <h2 class="my-2 text-2xl text-white border-b-2">New Vehicle for {{ $business->name }}</h2>
        <form action="{{ route('civilian.businesses.vehicle.store', $business->id) }}" class="flex flex-wrap -mx-4"
            method="POST">
            @csrf
            ...
            <div class="w-full px-4">
                <div class="mb-6 space-y-3 flex justify-between items-center">
                    ...
                    <a class="delete-button-md" href="{{ route('civilian.businesses.show', $business->id) }}">Cancel</a>
                </div>
            </div>
        </form>
