<aside
    class="z-5 flex-shrink-0 hidden w-64 overflow-y-auto bg-[#101825] md:block scrollbar-hide border-r border-gray-700">

    @livewire('civilian.civilian-sidebar')

</aside>
<!-- Mobile sidebar -->
<!-- Backdrop -->
<div class="fixed inset-0 z-5 flex items-end bg-black bg-opacity-50 md:bg-opacity-0 sm:items-center sm:justify-center"
