                            ...
                            <div class="border-b-2 border-x-2 w-full p-2 select-none" x-data="{ isOpen: false }">
                                <h3 @click="isOpen = !isOpen"
                                    ...
                                    <svg class="w-6 h-6" fill="none" stroke-width="1.5" stroke="currentColor"
                                        ...
                                        <path d="M4.5 15.75l7.5-7.5 7.5 7.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </h3>
                                <div class="" x-show="isOpen">
                                        ...
                                        @foreach ($vehicle->civilian->vehicles as $vehicle)
                                            ...
                                            <p>
                                                <a class="{{ $status_color }} inline-flex items-center"
                                                    ...
                                                    <svg class="w-4 h-4 text-blue-700 ml-2" fill="none"
            ...
            <div class="mt-3 flex justify-between">
                <div class="flex flex-col">
                    <div>
                        ...
                        <a class="edit-button-md" href="{{ route('cad.vehicle.return', $vehicle->plate) }}">Refresh
                            Data</a>
                    </div>
                ...
                <div>
                    <form action="{{ route('cad.vehicle.link_to_call', $vehicle->plate) }}" class="space-y-2"
                        method="POST">
                        @csrf
