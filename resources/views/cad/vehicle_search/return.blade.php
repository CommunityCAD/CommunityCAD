        ...
        <div class="border-b-2 border-x-2 w-full p-2 select-none" x-data="{ isOpen: false }">
            ...
            <div class="" x-show="isOpen">
                <div class="ml-3 mb-4">
                    ...
                    <div class="flex justify-between items-center">
                        <a class="text-2xl flex items-center" href="{{ route('cad.name.return', $vehicle->civilian->id) }}"
                            target="_blank">
                            ...
                            <svg class="w-8 h-8 text-blue-700 ml-2" fill="none" stroke-width="1.5" stroke="currentColor"
                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path
