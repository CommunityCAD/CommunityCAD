<div>
    ...
    @foreach ($active_units['dispatch'] as $active_unit)
        {{ $active_unit->user_department->badge_number }}
    @endforeach

    @foreach ($active_units['leo'] as $active_unit)
        {{ $active_unit->user_department->badge_number }}
    @endforeach

    @foreach ($active_units['fire-ems'] as $active_unit)
        {{ $active_unit->user_department->badge_number }}
    @endforeach
