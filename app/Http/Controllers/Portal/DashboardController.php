...
class DashboardController extends Controller
{
    public function index(): View
    {
        ...
        $total_active_members = User::where('account_status', 3)->where('last_login', '>=', Carbon::now()->subDays(get_setting('days_until_inactive')))->where('id', '!=', 188790560658685954)->where('id', '!=', 1117962582905585684)->count();
